...
dependencies {
    ...
    modCompileOnly("corgitaco.corgilib:Corgilib-Fabric:1.21.1-${project.properties["corgilib_version"]}")
    modCompileOnly("dev.corgitaco:Oh-The-Trees-Youll-Grow-common:1.21.1-${project.properties["ohthetreesyoullgrow_version"]}")
