...
public class RecipeGenerator extends RecipeProvider {
    ...
    private RecipeGenerator(HolderLookup.Provider provider, RecipeOutput recipeOutput) {
    ...
    protected void buildRecipes() {
        BWGWoodSet.woodsets().forEach(set -> {
            ...
            shaped(RecipeCategory.BUILDING_BLOCKS, set.bookshelf())
                    .define('#', set.planks())
                    .define('X', Items.BOOK)
                    .pattern("###")
                    .pattern("XXX")
                    ...
                    .save(output);
            shaped(RecipeCategory.DECORATIONS, set.craftingTable())
                    .define('#', set.planks())
                    .pattern("##")
                    .pattern("##")
                    .group("planks")
            ...
            chestBoat(set.chestBoatItem().get(), set.planks());
        });
        ...
        shapeless(RecipeCategory.BUILDING_BLOCKS, Items.BIRCH_PLANKS, 4)
                .requires(BWGItemTags.PALO_VERDE_LOGS)
                .group("planks")
                .unlockedBy("has_logs", has(BWGItemTags.PALO_VERDE_LOGS))
                .save(output, createKey("birch_planks_from_palo_verde_logs"));
        ...
        SimpleCookingRecipeBuilder.smelting(Ingredient.of(BWGItems.YUCCA_FRUIT.get()), RecipeCategory.FOOD, BWGItems.COOKED_YUCCA_FRUIT.get(), 0.35F, 200)
                ...
                .save(output, createKey("cooked_yucca_fruit_from_smelting"));
        ...
        SimpleCookingRecipeBuilder.campfireCooking(Ingredient.of(BWGItems.YUCCA_FRUIT.get()), RecipeCategory.FOOD, BWGItems.COOKED_YUCCA_FRUIT.get(), 0.35F, 600)
                .unlockedBy(getHasName(BWGItems.YUCCA_FRUIT.get()), has(BWGItems.YUCCA_FRUIT.get()))
                .save(output, createKey("cooked_yucca_fruit_from_camfire"));
        ...
        SimpleCookingRecipeBuilder.smoking(Ingredient.of(BWGItems.YUCCA_FRUIT.get()), RecipeCategory.FOOD, BWGItems.COOKED_YUCCA_FRUIT.get(), 0.35F, 100)
                .unlockedBy(getHasName(BWGItems.YUCCA_FRUIT.get()), has(BWGItems.YUCCA_FRUIT.get()))
                .save(output, createKey("cooked_yucca_fruit_from_smoker"));
        ...
        SimpleCookingRecipeBuilder.smelting(Ingredient.of(BWGItems.ODDION_BULB.get()), RecipeCategory.FOOD, BWGItems.COOKED_ODDION_BULB.get(), 0.35F, 200)
                ...
                .save(output, createKey("cooked_oddion_bulb_from_smelting"));
        ...
        SimpleCookingRecipeBuilder.campfireCooking(Ingredient.of(BWGItems.ODDION_BULB.get()), RecipeCategory.FOOD, BWGItems.COOKED_ODDION_BULB.get(), 0.35F, 600)
                .unlockedBy(getHasName(BWGItems.ODDION_BULB.get()), has(BWGItems.ODDION_BULB.get()))
                .save(output, createKey("cooked_oddion_bulb_from_campfire"));
        ...
        SimpleCookingRecipeBuilder.smoking(Ingredient.of(BWGItems.ODDION_BULB.get()), RecipeCategory.FOOD, BWGItems.COOKED_ODDION_BULB.get(), 0.35F, 100)
                .unlockedBy(getHasName(BWGItems.ODDION_BULB.get()), has(BWGItems.ODDION_BULB.get()))
                .save(output, createKey("cooked_oddion_bulb_from_smoker"));

        shaped(RecipeCategory.FOOD, BWGItems.ALLIUM_ODDION_SOUP.get())
        ...
        shaped(RecipeCategory.FOOD, BWGItems.BLOOMING_ODDION.get())
                .define('#', Items.EGG)
        ...
        shapeless(RecipeCategory.BREWING, BWGItems.ALOE_VERA_JUICE.get(), 4)
        ...
        SimpleCookingRecipeBuilder.campfireCooking(Ingredient.of(BWGItems.WHITE_PUFFBALL_CAP.get()), RecipeCategory.FOOD, BWGItems.COOKED_WHITE_PUFFBALL_CAP.get(), 0.35F, 600)
                .unlockedBy(getHasName(BWGItems.WHITE_PUFFBALL_CAP.get()), has(BWGItems.WHITE_PUFFBALL_CAP.get()))
                .save(output, createKey("cooked_white_puffball_cap_from_campfire"));
        ...
        SimpleCookingRecipeBuilder.smoking(Ingredient.of(BWGItems.WHITE_PUFFBALL_CAP.get()), RecipeCategory.FOOD, BWGItems.COOKED_WHITE_PUFFBALL_CAP.get(), 0.35F, 100)
                .unlockedBy(getHasName(BWGItems.WHITE_PUFFBALL_CAP.get()), has(BWGItems.WHITE_PUFFBALL_CAP.get()))
                .save(output, createKey("cooked_white_puffball_cap_from_smoker"));

        shapeless(RecipeCategory.FOOD, BWGItems.WHITE_PUFFBALL_STEW.get())
                .requires(Items.BOWL)
        ...
        dyeTagRecipe(output, Items.BLACK_DYE, BWGItemTags.MAKES_BLACK_DYE);
        dyeTagRecipe(output, Items.BLUE_DYE, BWGItemTags.MAKES_BLUE_DYE);
        //dyeTagRecipe(recipeOutput, Items.BROWN_DYE, BWGItemTags.MAKES_BROWN_DYE);
        dyeTagRecipe(output, Items.CYAN_DYE, BWGItemTags.MAKES_CYAN_DYE);
        //dyeTagRecipe(recipeOutput, Items.GRAY_DYE, BWGItemTags.MAKES_GRAY_DYE);
        dyeTagRecipe(output, Items.GREEN_DYE, BWGItemTags.MAKES_GREEN_DYE);
        ...
        dyeTagRecipe(output, Items.MAGENTA_DYE, BWGItemTags.MAKES_MAGENTA_DYE);
        dyeTagRecipe(output, Items.ORANGE_DYE, BWGItemTags.MAKES_ORANGE_DYE);
        dyeTagRecipe(output, Items.PURPLE_DYE, BWGItemTags.MAKES_PURPLE_DYE);
        dyeTagRecipe(output, Items.RED_DYE, BWGItemTags.MAKES_RED_DYE);
        dyeTagRecipe(output, Items.WHITE_DYE, BWGItemTags.MAKES_WHITE_DYE);
        dyeTagRecipe(output, Items.YELLOW_DYE, BWGItemTags.MAKES_YELLOW_DYE);
        dyeTagRecipe(output, Items.PINK_DYE, BWGItemTags.MAKES_PINK_DYE);

        twoByTwoPackertoFourWithStoneCutting(output, RecipeCategory.BUILDING_BLOCKS, BWGBlocks.RED_ROCK_BRICKS_SET.getBase(), BWGBlocks.RED_ROCK_SET.getBase());
        shapeless(RecipeCategory.BUILDING_BLOCKS, BWGBlocks.MOSSY_RED_ROCK_BRICKS_SET.getBase())
        ...
        chiseled(RecipeCategory.BUILDING_BLOCKS, BWGBlocks.CHISELED_RED_ROCK_BRICKS_SET.getBase(), BWGBlocks.RED_ROCK_BRICKS_SET.getBase());
        shapeless(RecipeCategory.BUILDING_BLOCKS, BWGBlocks.ROCKY_STONE_SET.getBase(), 2)
                .requires(Items.COBBLESTONE)
                .requires(Items.STONE)
                .unlockedBy(getHasName(Items.COBBLESTONE), has(Items.COBBLESTONE))
                .unlockedBy(getHasName(Items.STONE), has(Items.STONE))
                .save(output);
        shapeless(RecipeCategory.BUILDING_BLOCKS, BWGBlocks.MOSSY_STONE_SET.getBase())
                .requires(Items.STONE)
                .requires(Items.VINE)
                .group("mossy_stone")
                .unlockedBy(getHasName(Items.VINE), has(Items.VINE))
        ...
        twoByTwoPackertoFourWithStoneCutting(output, RecipeCategory.BUILDING_BLOCKS, BWGBlocks.DACITE_BRICKS_SET.getBase(), BWGBlocks.DACITE_SET.getBase());
        twoByTwoPackertoFourWithStoneCutting(output, RecipeCategory.BUILDING_BLOCKS, BWGBlocks.DACITE_TILE_SET.getBase(), BWGBlocks.DACITE_BRICKS_SET.getBase());
        shaped(RecipeCategory.BUILDING_BLOCKS, BWGBlocks.DACITE_PILLAR.get())
        ...
        shaped(RecipeCategory.BUILDING_BLOCKS, BWGBlocks.WINDSWEPT_SANDSTONE_PILLAR.get())
        ...
        shaped(RecipeCategory.FOOD, Items.GOLDEN_APPLE)
                ...
                .save(output, createKey("golden_apple_from_green_apple"));

        sandToGlass(output, BWGBlocks.BLACK_SAND_SET, Items.BLACK_STAINED_GLASS);
        sandToGlass(output, BWGBlocks.BLUE_SAND_SET, Items.BLUE_STAINED_GLASS);
        sandToGlass(output, BWGBlocks.PINK_SAND_SET, Items.PINK_STAINED_GLASS);
        sandToGlass(output, BWGBlocks.PURPLE_SAND_SET, Items.PURPLE_STAINED_GLASS);
        sandToGlass(output, BWGBlocks.WHITE_SAND_SET, Items.WHITE_STAINED_GLASS);
        ...
        shapeless(RecipeCategory.FOOD, BWGItems.GREEN_APPLE_PIE.get())
        ...
        shapeless(RecipeCategory.FOOD, BWGItems.BLUEBERRY_PIE.get())
        ...
        shaped(RecipeCategory.MISC, BWGBlocks.CATTAIL_THATCH.get(), 4)
        ...
        shapeless(RecipeCategory.DECORATIONS, Items.PURPLE_WOOL)
                ...
                .save(output, createKey("purple_wool_from_allium_petal_block"));

        shapeless(RecipeCategory.DECORATIONS, Items.WHITE_WOOL)
                ...
                .save(output, createKey("white_wool_from_white_allium_petal_block"));

        shapeless(RecipeCategory.DECORATIONS, Items.PINK_WOOL)
                ...
                .save(output, createKey("pink_wool_from_pink_allium_petal_block"));

        shapeless(RecipeCategory.DECORATIONS, Items.RED_WOOL)
                ...
                .save(output, createKey("red_wool_from_rose__petal_block"));

        shapeless(RecipeCategory.BUILDING_BLOCKS, BWGBlocks.SANDY_DIRT.get(), 4)
                .requires(Items.SAND, 2)
                .requires(Items.DIRT, 2)
                .unlockedBy(getHasName(Items.SAND), has(Items.SAND))
                .save(output);

        shaped(RecipeCategory.DECORATIONS, BWGBlocks.FORAGERS_TABLE.get())
        ...
        shapeless(RecipeCategory.BUILDING_BLOCKS, BWGBlocks.PACKED_PALE_MUD.get())
                .requires(BWGBlocks.PALE_MUD.get())
                .requires(Items.WHEAT)
                .unlockedBy(getHasName(BWGBlocks.PALE_MUD.get()), has(BWGBlocks.PALE_MUD.get()))
                .save(output);

        shaped(RecipeCategory.BUILDING_BLOCKS, BWGBlocks.PALE_MUD_BRICKS_SET.getBase(), 4)
        ...
        shapeless(RecipeCategory.MISC, BWGItems.BLUE_GLOWCANE_POWDER.get(), 3)
        ...
        shapeless(RecipeCategory.MISC, BWGItems.GREEN_GLOWCANE_POWDER.get(), 3)
        ...
        shapeless(RecipeCategory.MISC, BWGItems.RED_GLOWCANE_POWDER.get(), 3)
        ...
        shapeless(RecipeCategory.MISC, BWGItems.YELLOW_GLOWCANE_POWDER.get(), 3)
        ...
        shapeless(RecipeCategory.DECORATIONS, BWGBlocks.BLUE_GLOW_BOTTLE.get())
        ...
        shapeless(RecipeCategory.DECORATIONS, BWGBlocks.GREEN_GLOW_BOTTLE.get())
        ...
        shapeless(RecipeCategory.DECORATIONS, BWGBlocks.RED_GLOW_BOTTLE.get())
        ...
        shapeless(RecipeCategory.DECORATIONS, BWGBlocks.YELLOW_GLOW_BOTTLE.get())
        ...
        shapeless(RecipeCategory.FOOD, Items.PUMPKIN_PIE)
        ...
        shaped(RecipeCategory.BUILDING_BLOCKS, BWGBlocks.PALE_JACK_O_LANTERN.get())
                .define('A', BWGBlocks.CARVED_PALE_PUMPKIN.get())
                .define('B', Items.SOUL_TORCH)
                .pattern("A")
                .pattern("B")
                .unlockedBy(getHasName(BWGBlocks.CARVED_PALE_PUMPKIN.get()), has(BWGBlocks.CARVED_PALE_PUMPKIN.get()))
                .save(output, createKey("pale_jack_o_lantern_from_soul_torch"));
        ...
        shaped(RecipeCategory.BUILDING_BLOCKS, BWGBlocks.PALE_JACK_O_LANTERN.get())
                ...
                .pattern("B")
                .unlockedBy(getHasName(BWGBlocks.CARVED_PALE_PUMPKIN.get()), has(BWGBlocks.CARVED_PALE_PUMPKIN.get()))
                .save(output, createKey("pale_jack_o_lantern_from_soul_fruit"));

        shaped(RecipeCategory.DECORATIONS, Blocks.SOUL_TORCH, 4)
                ...
                .save(output, createKey("soul_torch_from_soul_fruit"));

        shaped(RecipeCategory.BUILDING_BLOCKS, BWGBlocks.PALE_MUD.get(), 8)
    ...
    private static ResourceKey<Recipe<?>> createKey(String name) {
        return BiomesWeveGone.key(Registries.RECIPE, name);
    }
    ...
    public static class Runner extends RecipeProvider.Runner
    {
        ...
        public @NotNull String getName() {
            return "Biomes We've Gone Recipes";
        }
    }

    private void sandToGlass(RecipeOutput finishedRecipeConsumer, BWGSandSet set, Item glass) {
        SimpleCookingRecipeBuilder.smelting(Ingredient.of(set.getSand()), RecipeCategory.BUILDING_BLOCKS, glass, 0.1F, 200)
                ...
                .save(finishedRecipeConsumer, createKey(getHasName(glass).replace("has_", "") + "_from_" + getHasName(set.getSand()).replace("has_", "")));
    }
    ...
    private void twoByTwoPackertoFourWithStoneCutting(RecipeOutput finishedRecipeConsumer, RecipeCategory category, ItemLike packed, ItemLike unpacked) {
        shaped(category, packed, 4)
                .define('#', unpacked)
                .pattern("##")
                .pattern("##")
	...
	private void dyeAbleRecipe(RecipeOutput finishedRecipeConsumer, ItemLike item, ItemLike ingredient, TagKey<Item> dye) {
		shaped(RecipeCategory.BUILDING_BLOCKS, item, 8)
				.define('#', dye)
				.define('X', ingredient)
				.pattern("XXX")
				.pattern("X#X")
    ...
    private void dyeTagRecipe(RecipeOutput finishedRecipeConsumer, Item dye, TagKey<Item> tag) {
        shapeless(RecipeCategory.MISC, dye)
                .requires(tag)
                .unlockedBy(tag.toString(), has(tag))
                .group(getHasName(dye).replace("has_", ""))
                .save(finishedRecipeConsumer, createKey(getHasName(dye).replace("has_", "")+ "_from_bwg_tag"));
    }
}
